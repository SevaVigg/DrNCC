...
plotPCANormDir <- file.path(getwd(), "Plot", "PCA", "Normalized")

resDir	<- file.path(getwd(), "Res")

dir.create( plotDir, showWarnings = FALSE)
dir.create( plotPCADir, showWarnings = FALSE)
dir.create( plotPCANormDir, showWarnings = FALSE)

drawDir <- plotPCANormDir
...
png( paste0( drawDir, .Platform$file.sep, "GeneDendroNormalized.png"))
	par(cex = 0.7)
